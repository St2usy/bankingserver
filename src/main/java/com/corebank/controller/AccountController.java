...
public class AccountController {
    ...
    public AccountResponse deposit(
        ...
        return transactionService.deposit(accountId, request.getAmount(), idempotencyKey);
    }
    ...
    public AccountResponse withdraw(
            ...
            @RequestHeader(value = "Idempotency-Key", required = false) String idempotencyKey,
            @Valid @RequestBody AmountRequest request) {
        return transactionService.withdraw(accountId, request.getAmount(), idempotencyKey);
    }
    ...
    public TransferResponse transfer(
        ...
        return transactionService.transfer(
                fromAccountId, request.getToAccountId(), request.getAmount(), idempotencyKey);
    }
}
